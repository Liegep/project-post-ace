...
import { PostStatus, STATUS_CONFIG, LABEL_CONFIG } from "@/types/post";
      ...
      <header className="border-b bg-card px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Gerencie seus posts e aprovações</p>
          </div>
                ...
                <div key={status} className="rounded-xl border bg-card/50 p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {columnPosts.length === 0 && (
                      <p className="py-8 text-center text-sm text-muted-foreground">Nenhum post</p>
                    )}
                  </div>
                </div>
              );
